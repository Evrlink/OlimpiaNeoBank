...
/** Accessible Receive entry — share/link flow comes in a later phase. */
      ...
      >
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.subtitle}>
            Share how someone can pay you on Olimpia. Your receive details will live here.
          </Text>

          <View style={styles.card}>
            <Text style={styles.cardTitle}>Ready when you are</Text>
            <Text style={styles.cardBody}>
              You’ll get a simple way to share your Olimpia handle or link — no wallet
              addresses, just dollars.
            </Text>
          </View>
        </View>
      </ScrollView>
