...
> **HISTORICAL RESEARCH ONLY — do not use for implementation.**  
> Archived 2026-08-07. Dakota is **not** an active V1 provider.  
> Active V1 funding is **Receive USDC on Base** into a Privy embedded wallet ([ADR-015](../../architecture/ArchitectureDecisionLog.md), [V1Architecture.md](../../V1Architecture.md)).  
> Coinbase Headless is **post-V1 preserved code**, not the current V1 funding provider.  
